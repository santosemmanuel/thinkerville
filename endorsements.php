...
<div class="container-fluid">
  ...
  <div class="row bg-warning p-5">
    <h1 class="text-center fw-bolder mb-5">Video Discussions</h1>
    <div class="container text-center">
      <div class="row align-items-end">
        <div class="col-md-4">
          <h5><i class="fa-solid fa-scale-balanced"></i>&nbsp; Evolution of the Philippine Constitution</h5>
          <div class="ratio ratio-21x9 video_discuss">
            <iframe src="https://drive.google.com/file/d/1jFnNpxp_Mbymy7-UTJcM8H1OoSzVY9Ff/preview" allowfullscreen></iframe>
          </div>
        </div>
        <div class="col-md-4">
          <h5><i class="fa-solid fa-square-root-variable"></i>&nbsp; PEMDAS</h5>
          <div class="ratio ratio-21x9 video_discuss">
            <iframe src="https://drive.google.com/file/d/1jEiMTc-A28cvO2QQtyWpaQI76ZiyQrAq/preview" allowfullscreen></iframe>
          </div>
        </div>
        <div class="col-md-4">
          <h5><i class="fa-solid fa-language"></i>&nbsp; Vocabulary</h5>
          <div class="ratio ratio-21x9 video_discuss">
            <iframe src="https://drive.google.com/file/d/1tIPogfD0DiD30VIPVOrEziJqZFABRQ32/preview" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
